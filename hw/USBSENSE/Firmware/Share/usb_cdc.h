...
//api for the user:
#define usb_cdc_kbhit() (usb_cdc_get_buffer_nextin!=usb_cdc_get_buffer_nextout)
#define usb_cdc_putready() (usb_cdc_put_buffer_nextin<USB_CDC_PUT_BUFFER_SIZE)
#define usb_cdc_connected() (usb_cdc_got_set_line_coding)
void usb_cdc_putc_fast(char c);
char usb_cdc_getc(void);
void usb_cdc_putc(char c);

//input.c ported to CCS:
float get_float_usb();
...
#define __USB_PIC_PERIF__	1
 ...
 #else
  #include "..\share\pic18_usb.h"   //Microchip 18Fxx5x hardware layer for usb.c
 #endif
#else
...
#define USB_CDC_PUT_BUFFER_SIZE  64
int8 usb_cdc_put_buffer[USB_CDC_PUT_BUFFER_SIZE];
int8 usb_cdc_put_buffer_nextin=0;

#define USB_CDC_GET_BUFFER_SIZE  64
int8 usb_cdc_get_buffer[USB_CDC_GET_BUFFER_SIZE];
int8 usb_cdc_get_buffer_nextin=0;
int8 usb_cdc_get_buffer_nextout=0;
...
void usb_isr_tok_out_cdc_data_dne(void) {
   char buff[USB_CDC_DATA_OUT_SIZE];
   int8 i;
   int8 len;

   len=usb_get_packet(USB_CDC_DATA_OUT_ENDPOINT, buff, USB_CDC_DATA_OUT_SIZE);
   for (i=0;i<len;i++) {
      usb_cdc_get_buffer[usb_cdc_get_buffer_nextin++]=buff[i];
      if (usb_cdc_get_buffer_nextin >= USB_CDC_GET_BUFFER_SIZE)
         usb_cdc_get_buffer_nextin=0;
   }
}
...
char usb_cdc_getc(void) {
   ...
   c=usb_cdc_get_buffer[usb_cdc_get_buffer_nextout++];
   if (usb_cdc_get_buffer_nextout >= USB_CDC_GET_BUFFER_SIZE)
      usb_cdc_get_buffer_nextout=0;
...
void usb_cdc_putc_fast(char c) {
   ...
   if (usb_cdc_put_buffer_nextin >= USB_CDC_PUT_BUFFER_SIZE) {
      usb_cdc_put_buffer_nextin=0;  //we just overflowed the buffer!
   }
